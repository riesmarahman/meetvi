                  ...
                  <div class="x_content">
                    ...
                    <div class="x_content">
                      <table id="datatable" class="table table-striped table-bordered">
                        <thead>
                          <a href="<?php echo base_url(); ?>index.php/Dosen_kontrol/Tambah_dosen" class="btn btn-sm btn-info"> Tambah Dosen</a>
                        ...
                        <tbody>
                          ...
                          foreach ($dosen->result() as $row): ?>
                            <tr>
                              ...
                              <td> 
                                <a href="<?php echo site_url('Dosen_Kontrol/edit_data_dosen/'. $row->id); ?>" class="btn btn-sm btn-info">Tambah Akun</a>
                              </td>
                            </tr>
                          <?php endforeach; ?>
