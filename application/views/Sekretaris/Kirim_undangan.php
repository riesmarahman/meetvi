                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                      ...
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"method="post" action="<?php echo base_url() ?>index.php/Sekretaris_Kontrol/kirim_undangan">

                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for=""> No Undangan :<span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $id_undangan; ?>" disabled>
                          </div>
                        </div>

                        <input type="hidden" name="input_id" value="<?php echo $id_undangan; ?>" required>

                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for=""> Rapat :<span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="input_rapat" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $id_rapat; ?>" disabled>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" name="input_ruang" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $id_ruang; ?>" disabled>
                          </div>
                        </div>

                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for=""> Dosen :<span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="form-control" name="input_dosen" id="dosen" required>
