                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        foreach ($undangan as $row): ?>
                          <tr>
                            <td><?php echo $no++;?></td>
                            <td><?php echo $row['id_undangan']; ?></td>
                            <td><?php echo $row['topik']; ?></td>
                            <td><?php echo $row['nama_ruang']; ?></td>
                            <td><?php echo $row['nama_prodi']; ?></td>
                            <td> 
                              <a href="<?php echo site_url('Sekretaris_Kontrol/edit_data_undangan/'. $row['id_undangan']); ?>" class="btn btn-sm btn-info">Kirim undangan</a>
                            </td>
                            </tr><?php endforeach; ?>
                          </tbody>
                        </table>
