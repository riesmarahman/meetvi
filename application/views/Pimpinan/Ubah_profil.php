              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="<?php echo site_url('Dosen_Kontrol/ubah_profil');?>">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for=""> Username :<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="input_username" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $username; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="input_password" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $password; ?>">
                        </div>
                      </div>

                   <input type="hidden" name="input_id" value="<?php echo $id; ?>" required>
