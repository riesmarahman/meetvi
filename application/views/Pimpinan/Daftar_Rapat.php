                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        foreach ($rapat->result() as $row): ?>
                          ...
                          <td> 
                            <a href="<?php echo site_url('Rapat_Kontrol/edit_data/'. $row->id); ?>" class="btn btn-sm btn-info"> Edit</a>
                            <a href="<?php echo site_url('Rapat_Kontrol/hapus_rapat/'.$row->id); ?>" class="btn btn-sm btn-danger"> Delete</a>
                          </td>
                          </tr><?php endforeach; ?>
                        </tbody>
                      </table>
