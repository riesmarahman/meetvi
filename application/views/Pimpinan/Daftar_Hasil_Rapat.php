                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        foreach ($hasil as $row): ?>
                          ...
                          <td> 
                            <a href="<?php echo site_url('Rapat_Kontrol/edit_data_hasil/'. $row['id_hasil']); ?>" class="btn btn-sm btn-info"> Edit</a>
                            <a href="<?php echo site_url('Rapat_Kontrol/hapus_hasil_rapat/'.$row['id_hasil']); ?>" class="btn btn-sm btn-danger"> Delete</a>
                          </td>
                            </tr><?php endforeach; ?>
                          </tbody>
                        </table>
