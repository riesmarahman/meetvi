            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-edit"></i> Jadwal <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="<?php echo base_url() ?>index.php/Dosen_Kontrol/Tambah_jadwal"><i class="fa fa-list"></i> Tambah Jadwal</a></li>
                    <li><a href="<?php echo base_url() ?>index.php/Dosen_Kontrol"><i class="fa fa-plus"></i> Daftar Jadwal</a></li>  
                  </ul> 
                </li>
              </div>
            </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"method="post" action="<?php echo base_url() ?>index.php/Peserta_Kontrol/Tambah_hasil_rapat">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for=""> ID Rapat :<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="keterangan" name="" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $id_undangan_rapat ?>" disabled>
                        </div>
                      </div>

                      <input type="hidden" name="input_id" value="<?php echo $id_undangan_rapat; ?>" required>
                      <input type="hidden" name="input_dosen" value="<?php echo $id_dosen; ?>" required>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <textarea id="" required="required" class="form-control" name="input_notula" data-parsley-trigger="keyup" ></textarea>
                       </div>
                     </div>
