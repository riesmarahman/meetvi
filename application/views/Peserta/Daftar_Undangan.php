                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        foreach ($undangan as $row ):
                           ...
                           <tr>
                            <td><?php echo $no++;?></td>
                            <td><?php echo $row['id_undangan_rapat']; ?></td>
                            <td><?php echo $row['topik']; ?></td>
                            <td><?php echo $row['nama_ruang']; ?></td>
                            <td><?php echo $row['tgl_pelaksanaan']; ?></td>
                            <td><?php echo $row['waktu']; ?></td>                            
                            <td> 
                              <a href="<?php echo site_url('Peserta_Kontrol/edit_data/'. $row['id_undangan_rapat']); ?>" class="btn btn-sm btn-info">Tambah Hasil Rapat</a>
                            </td>
                          </tr>
                        <?php endforeach; ?>
