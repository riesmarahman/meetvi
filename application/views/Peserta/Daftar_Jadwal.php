                    ...
                    <div class="x_content">
                      <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                          <?php
                          $no = 1;
                          foreach($dt_jadwal->result() as $jadwal) :
                            echo '<tr>';
                            echo '<td>' . $no++ . '</td>';
                            echo '<td>' . $jadwal->tanggal . '</td>';
                            echo '<td>' . $jadwal->keterangan . '</td>';
                            echo '<td>
                            <a href="' . base_url().'index.php/Dosen_Kontrol/edit_data/' . $jadwal->id . '" class="btn btn-sm btn-circle btn-warning"><span class="glyphicon glyphicon glyphicon-edit" aria-hidden="true">
                            <a href="' . base_url().'index.php/Dosen_Kontrol/hapus_jadwal/' . $jadwal->id . '" class="btn btn-sm btn-circle btn-danger"><span class="glyphicon glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>';
                            echo '</tr>';
                          endforeach;
                          ?>
                        </tbody>
