              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-edit"></i> Rapat <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="<?php echo base_url() ?>index.php/Peserta_Kontrol/Lihat_undangan"><i class="fa fa-list"></i> Undangan Rapat</a></li>
                    <li><a href="<?php echo base_url() ?>index.php/Peserta_Kontrol/Hasil_rapat"><i class=" fa fa-list"></i> Hasil Rapat</a></li>  
                  </ul> 
                </li>
                <li><a><i class="fa fa-edit"></i> Jadwal <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="<?php echo base_url() ?>index.php/Dosen_Kontrol/Tambah_jadwal"><i class="fa fa-plus"></i> Tambah Jadwal</a></li>
                    <li><a href="<?php echo base_url() ?>index.php/Dosen_Kontrol"><i class="fa fa-list"></i> Daftar Jadwal</a></li>  
                  </ul> 
                </li>
              </div>
            </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="<?php echo base_url(); ?>index.php/Dosen_Kontrol/profil"> Profile</a></li>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"method="post" action="<?php echo base_url() ?>index.php/Dosen_Kontrol/Ubah_jadwal">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for=""> Tanggal :<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" id="tgl" name="input_tgl" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $tanggal; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for=""> Keterangan :<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="keterangan" name="input_keterangan" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $keterangan; ?>">
                        </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="<?php echo base_url() ?>index.php/Dosen_Kontrol/" type="reset" class="btn btn-warning"><i class="glyphicon glyphicon-remove"></i> Batal</a>
