          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><?= $this->session->userdata['info']['nama']; ?><small></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                   <?php foreach ($profil->result() as $row): ?>
                   <?php foreach ($akun->result() as $row1): ?>
                      <ul class="list-unstyled user_data">
                        <li> NIP : <?= $row->nip; ?></li>
                        <li> Jabatan : <?= $row->jabatan; ?></li>
                        <li> Username : <?= $row1->username; ?></li>
                        <li> Password : <?= $row1->password; ?></li>
                    <?php endforeach ?>
                    <?php endforeach ?>
                      <a href="<?php echo site_url('Dosen_Kontrol/edit_data_profil/'. $row1->id); ?>"class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>
                      <br />
                  </div>
                </div>
              </div>
